...
| # | Achado | Situação |
|---|---|---|
| 1 | `JUNDIAI/PR` na qualificação da CONTRATADA. Jundiaí é município de **São Paulo**; o cartão CNPJ da própria empresa traz `JUNDIAI/SP`. | ✅ **RESOLVIDO em 01/09/2026.** A revisão da diretoria confirmou o erro de digitação do modelo; o texto agora traz `JUNDIAI/SP`. |
