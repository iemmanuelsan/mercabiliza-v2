...
def blocos_assinatura_contrato(
    ...
    ``com_testemunhas`` é ``False`` por padrão desde a revisão de 01/09/2026:
    o modelo da Mercabiliza deixou de exigir testemunhas. O bloco continua
    implementado porque a assinatura testemunhal segue válida e outro modelo
    pode voltar a usá-la — mas quem quiser precisa pedir explicitamente.
    """
    itens: list = [
