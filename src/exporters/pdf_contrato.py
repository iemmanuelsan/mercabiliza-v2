...
def gerar_contrato(
    ...
    # Revisão de 01/09/2026: o modelo da Mercabiliza não usa mais
    # testemunhas. O parâmetro continua existindo porque a assinatura
    # por testemunhas segue válida em outros modelos de contrato, mas o
    # padrão agora é não incluir — e o template já não menciona.
