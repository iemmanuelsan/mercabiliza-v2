...
CONTRATADA_TELEFONE = "(19) 99775-6094"
CONTRATADA_EMAIL = "contato@mercabiliza.com.br"
CONTRATADA_SITE = ""
...
# --------------------------------------------------------------------------- #
# CONTRATADA — texto fixo da qualificação                                      #
# --------------------------------------------------------------------------- #
# Revisão de 01/09/2026, definida pela diretoria. Três mudanças em relação à
# versão anterior:
#
#   1. A MERCABILIZA SOLUCOES EM TECNOLOGIA E GESTAO LTDA saiu do contrato —
#      o serviço passou a ser exclusivamente contábil. (O título do contrato
#      também perdeu "E DE SOFTWARE", no template.)
#   2. O sócio administrador passou a ser nomeado, com RG, CPF e CRC. Isso
#      inverte a decisão anterior de "sem CRC e sem pessoa física"; contrato
#      contábil sem o CRC do responsável técnico é frágil perante o CFC.
#   3. JUNDIAI/PR virou JUNDIAI/SP. Era erro de digitação do modelo antigo:
#      Jundiaí é município de São Paulo, e o cartão CNPJ da própria empresa
#      traz SP. Estava sinalizado desde a auditoria e agora está resolvido.
#
# ⚠️ Os `**` marcam NEGRITO no PDF. A lista de itens em negrito foi definida
#    pela diretoria e é exatamente esta: razão social, CNPJ, nome do
#    administrador, RG, CPF e CRC. O endereço NÃO vai em negrito nesta versão
#    (na anterior ia) — não "corrija" isso sem confirmar.
CONTRATADA_QUALIFICACAO_FIXA = """Nossos serviços serão prestados por:

**MERCABILIZA SOLUCOES FISCAIS E CONTABEIS LTDA.** (CNPJ: **62.350.925/0001-10**), R ANCHIETA, 204, SALA 102, BAIRRO: VILA BOAVENTURA, JUNDIAI/SP, neste ato representada por seu sócio Administrador **LUIS FELIPE PEDI SILVA**, brasileiro, casado, contador, nascido em 10/12/1993, portador da cédula de identidade RG nº. **49514166** expedido pela SSP/SP, inscrito no CPF sob o nº. **378.007.638-11**, e no CRC SP sob o nº. **SP323775/O-2**."""
