...
revisado em 01/09/2026: apenas a **MERCABILIZA SOLUCOES FISCAIS E CONTABEIS
LTDA** (a empresa de tecnologia saiu — o serviço é exclusivamente contábil), com
o sócio administrador nomeado e o CRC do responsável técnico.

Os `**` no texto marcam **negrito** no PDF. A lista de itens em negrito foi
definida pela diretoria e é exatamente esta: razão social, CNPJ, nome do
administrador, RG, CPF e CRC.
